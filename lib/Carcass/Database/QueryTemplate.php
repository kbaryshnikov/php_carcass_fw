...
/**
 * Base database query template parser, based on StringTemplate
 */
abstract class QueryTemplate extends StringTemplate {
    ...
    public function name($name) {
        return join('.', array_map([$this, 'escapeNamePart'], explode('.', $name)));
    }
